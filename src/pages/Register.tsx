    ...
    <div className="min-h-screen bg-[var(--bg-0)] text-[var(--text-1)] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-[440px]">
        ...
        <div className="jarvis-surface p-6" style={{ borderRadius: 'var(--r-2)', boxShadow: 'var(--shadow-2)' }}>
          <div className="text-xs font-medium tracking-[0.18em] text-[var(--text-3)]">CREATE ACCOUNT</div>
          <h1 className="mt-2 text-2xl font-semibold tracking-[-0.03em]">Register</h1>
          <p className="mt-2 text-sm text-[var(--text-2)] leading-6">
            Continue with Google to create your session. No extra forms, no noise.
          </p>
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="pt-2 text-sm text-[var(--text-2)]">
              ...
              <Link to="/login" className="ml-2 text-[var(--text-1)] underline underline-offset-4" style={{ textDecorationColor: 'rgba(59, 130, 246, 0.35)' }}>
                Login
              </Link>
            </div>
          </div>
